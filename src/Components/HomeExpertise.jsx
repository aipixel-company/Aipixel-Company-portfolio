...
const expertiseData = [
  {
    ...
    description: "Craft exceptional web experiences. AI Pixel specializes in building robust and scalable web applications that not only look stunning but can also handle explosive growth.",
    image: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHdlYiUyMGRlc2lnbnxlbnwwfHwwfHx8MA%3D%3D",
  },
  {
    id: 2,
    field: "UI/UX Design",
    name: "User Interface Design",
    description: "Design that delights. AI Pixel's UI/UX design team creates intuitive and engaging user interfaces that prioritize usability and aesthetics.",
    image: "https://images.unsplash.com/photo-1690228254548-31ef53e40cd1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHVpJTIwdXhiYWNrZ3JvdW5kfGVufDB8fDB8fHww",
  },
  {
    id: 3,
    field: "Artificial Intelligence",
    name: "AI Solutions",
    description: " Unlock the power of AI. AI Pixel leverages cutting-edge AI solutions to tackle complex business challenges. From automating tasks to personalizing experiences. ",
    image:
  ...
  },
  {
    ...
    field: "DevOps",
    name: "DevOps",
    description: " Streamline your development lifecycle. AI Pixel's DevOps experts ensure seamless collaboration between development and operations teams. ",
    image:
  ...
  },
  {
    ...
    description: "Apps that move mountains. AI Pixel helps you bring your mobile app ideas to life. Their team creates high-quality prototypes to validate your concept and ensure a smooth user experience across all devices.",
    image:
  ...
  },
  {
    ...
    field: "BlockChain",
    name: "BlockChain",
    description: "Build trust and transparency. AI Pixel brings blockchain expertise to the table, helping you design and develop secure, transparent applications.",
    image:
  ...
  },
  {
    ...
    description: " Deliver flawless experiences. AI Pixel's rigorous quality assurance (QA) process ensures your software is bug-free and delivers exceptional performance.",
    image:
  ...
  },
  {
    ...
    description: "Guarantee optimal functionality. AI Pixel's comprehensive software testing services leave no stone unturned.",
    image:
  ...
  },
  {
    ...
    field: "WordPress",
    name: "WordPress",
    description: "Empower your content creation. AI Pixel leverages the power of WordPress to create dynamic and visually appealing websites.",
    image:
  ...
  },
  {
    ...
    field: "Fintech",
    name: "Fintech",
    description: "Innovate in the financial landscape. AI Pixel offers specialized expertise in Fintech development.",
    image:
  ...
  },
  {
    ...
    description: "Keep your software running smoothly. AI Pixel provides ongoing application maintenance services to ensure your software remains secure, stable, and up-to-date.",
    image:
  ...
  },
  {
    ...
    description: "Designing interactive elements for user engagement is our specialty at AI Pixel.",
    image:
  ...
  },
  {
    ...
    description: " At AI Pixel, we understand the importance of effective project management. Our experienced team ensures that projects are completed on time, within budget and highest Quality",
    image:
  ...
  },
  {
    ...
    field: "AWS",
    name: "AWS",
    description: " Designing interactive elements for user engagement is our specialty at AI Pixel. We leverage the power of AWS to create scalable and reliable cloud solutions",
    image:
  ...
  },
  {
    ...
    description: "Understanding how to store and manipulate data efficiently is crucial in today's data-driven world. At AI Pixel, we have expertise in designing and implementing data structures and algorithms",
    image:
  ...
  },
  {
    ...
    description: " Learning various languages to create software programs is our bread and butter at AI Pixel. Our team of experienced developers is proficient in a wide range of programming languages",
    image:
  ...
  },
  {
    ...
    description: "Scale with agility. AI Pixel integrates your applications with leading cloud platforms, enabling scalability and flexibility.",
    image:
  ...
  },
  {
    ...
    name: "IDEs",
    description: "Comprehensive tools for writing and debugging code are indispensable for developers. At AI Pixel, we offer access to top-tier IDEs that provide a seamless development experience",
    image:
  ...
  },
  {
    ...
    field: "Databases",
    name: "Databases",
    description: "At AI Pixel, we specialize in designing and implementing databases that are efficient, scalable, and secure",
    image:
  ...
  // },
  {
    ...
    description: "At AI Pixel, we provide comprehensive training in networking basics.",
    image:
  ...
  },
  {
    ...
    name: "Software Testing",
    description: "At AI Pixel, we provide thorough training in the basics of software testing, equipping individuals and teams with the knowledge and skills",
    image:
  ...
  // },
  {
    ...
    name: "SDLC",
    description: " At AI Pixel, we follow a rigorous SDLC methodology that ensures the successful delivery of software projects from inception to deployment.",
    image:
...

  {
    ...
    name: "SEO",
    description: "At AI Pixel, we offer expertise in SEO strategies and techniques that help businesses increase their online visibility and achieve higher rankings in search engine results pages.",
    image:
...
export default function HomeExpertise() {
  const [filters, setFilters] = useState({
    ...
    need: "", // New filter state
    requirements: "", // New filter state
  });
  ...
  const handleResetFilters = () => {
    setFilters({
      ...
      service: "",
      technology: "",
      state: "", // Reset new filter state
      need: "", // Reset new filter state
      requirements: "", // Reset new filter state
    });
    setActiveQuestion(0);
  };
  ...
  const filteredExpertiseData = expertiseData.filter((expertise) => {
    // Filter by development, service, and technology
    ...
    // Filter by state, need, and requirements
  ...
  return (
    <div className="flex flex-col items-center w-full h-full p-10 bg-gray-50">
      <div className="w-full flex flex-col items-center pt-16 pb-10">
        <h1 className="text-3xl font-semibold mb-3 capitalize text-center">
        Unleash Your Digital Potential with Cutting-Edge Solutions
        </h1>
        <p className=" text-base font-light mb-3  text-center">
      ...
      <div className="flex flex-row w-full h-full">
                ...
                <div className="flex flex-wrap gap-2">
                  {question.options.map((option) => (
                    <button
                      ...
                      onClick={() =>
                        handleFilterChange(question.id, option, index)
                      }
        ...
        <div className="w-2/3 flex flex-col h-full pl-10">
          <div className="flex flex-row w-full h-[70vh] overflow-hidden">
            <div className="w-full flex flex-col h-[70vh]">
              <div
                className="flex overflow-x-auto space-x-4 h-[60vh] scrollbar"
