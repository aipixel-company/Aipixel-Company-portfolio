...
const BlogSection = () => {
  ...
  const slides = [
    ...
    {
      image: "https://images.unsplash.com/photo-1556742400-b5c4a996c6e1?w=400&auto=format&fit=crop&q=60&ixlib=rb-1.2.1&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHx8fHx8fHx8fA%3D%3D",
      title: "The role of technology in modern investing",
      description:
        "Technology is transforming the investment landscape. Explore how innovative tools and platforms can enhance your investment strategy...",
    },
  ];
