...
export default function Footer() {
  ...
  const linkClasses = "text-[#8791AD] hover:text-[#3567FF] transition-colors duration-200";
  const headingClasses = "text-lg font-bold text-white mb-4 tracking-wide";
  const socialIconClasses = "text-[#8791AD] hover:text-[#3567FF] transition-colors duration-200";

  return (
    <>
      <footer className="bg-[#070508] border-t border-white/10">
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="mb-6">
                <img
                  src={navlogo}
                  alt="AI Pixal Logo"
                  className="h-12 w-auto bg-white p-2 rounded-lg filter grayscale opacity-80"
                />
              </div>

              <div className="space-y-3">
                <p className="text-sm font-semibold text-white">Locations:</p>
                <div className="text-sm text-[#8791AD] space-y-2">
                  <div>
                    <span className="text-white font-medium block">Lahore HQ:</span>
                    37L Block Johar Town, Lahore
                  </div>
                  <div>
                    <span className="text-white font-medium block">Doha Office:</span>
                    Office 62 Street 517 RBF Admin Office QFZ Doha Qatar
                  </div>
                </div>

                <p className="text-sm font-semibold text-white pt-2">Get in Touch:</p>
                <p className="text-sm text-[#8791AD]">
      ...
      {/* Copyright Bar - Soft dark background */}
      <div className="bg-[#1E1D28]/40 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:flex sm:items-center sm:justify-between">
          <p className="text-center text-sm text-[#8791AD]">
          ...
          <div className="flex justify-center sm:justify-start mt-2 sm:mt-0 space-x-4">
            <Link to="/privacy-policy" className="text-sm text-[#8791AD] hover:text-[#3567FF] transition">Privacy</Link>
            <span className="text-white/20">|</span>
            <Link to="/terms-of-service" className="text-sm text-[#8791AD] hover:text-[#3567FF] transition">Terms</Link>
          </div>
        </div>
      </div>
    </>
